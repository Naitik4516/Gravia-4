...
def welcome_notification():
    notification.notify(
        ...
        app_icon = "Icons\Gravia icon.ico",
        timeout = 1,
    )
...
def speak(output):
    ...
    # # with different name to remove ambiguity             Ye bas jo yhe khe rahi use print karwane ke liye tha.
    # num += 1
    # print("Gravia : ", output)                          
  
    toSpeak = gTTS(text=output, lang='en', slow=False)
    file = ".mp3 "     #Agar jo yhe khe rahi he use bhi print karvana cahate ho to ye likho str(num)+".mp3 ", ".mp3 ki jagha"
    toSpeak.save(file)
...
def wishMe():
        ...
        if hour>=0 and hour<12:
            ...
            notification.notify(
                title = "Good Morning",
                message = gdm,
                app_icon = "G:\\Python Projects\\Gravia\\Icons\\wish-list.ico",
                timeout = 10,
            )
...
def sendEmail(to, Krishna):
    ...
    server.ehlo()
    server.starttls()
    server.login('Enter you email', 'Krishna 2021')
    server.sendmail('Enter you email', to, content)
    server.close()
...
if __name__ == "__main__":
    ...
    while True:
            ...
            if 'wikipedia' in query:  #if wikipedia found in the query then this block will be executed
                ...
                V = query.replace('','search in youtube')
                speak('playing vidio on youtube ' + V)
                pywhatkit.playonyt(V)        

            elif 'on youtube' in query:
                B = query.replace('','search in youtube')
                speak('playing vidio on youtube ' + B)
                pywhatkit.playonyt(B)  

            elif 'open youtube' in query:
                speak("Ok,here you go to youtube. opening please wait for a momment\n")
                print("Opening.....")
                webbrowser.open("https://www.youtube.com/")

            elif 'open instagram' in query:
                speak("Ok,here you go toinstagram. opening please wait for a momment\n")
                print("Opening.....")
                webbrowser.open("https://www.instagram.com/")

            elif 'open google' in query:
                speak("Ok,here you go to google. opening... please waitfor a moment\n")
                print("Opening.....")
                webbrowser.open("https://www.google.com/")

            elif 'open translater' in query:
                speak("Ok, google translate is opening her now. opening... please waitfor a moment\n")
                print("Opening")
                webbrowser.open("https://translate.google.com/")

            elif 'open stackoverflow' in query:
                speak("Ok. here you go to stackoverflow. Pleasewait for a moment\n")
                print("Opening.....")
                webbrowser.open("https://stackoverflow.com/")

            elif 'open gmail' in query:
                speak("Ok. here you go to gmail. Please wait for a momment\n")
                print("Opening.....")
                webbrowser.open("https://mail.google.com/mail/u/0/#inbox")

            elif 'open hotstar' in query:
                speak("Ok. here you go to Hotstar. Please wait for a momment\n")
                print("Opening.....")
                webbrowser.open("https://www.hotstar.com/in")

            elif 'open amazon' in query:
                speak("Ok. here you go to amazon.Please wait for a momment\n")
                print("Opening.....")
                webbrowser.open("https://www.amazon.com/")

            elif 'open facebook' in query:
                print("Opening.....")
                speak ("okay. here is facebook opening. Please wait for a momment\n")
                webbrowser.open("https://www.facebook.com/")

            elif 'open w3 schools' in query:
                speak("Okay. here is w3 schools opening. Please wait for a momment")
                print("Opening...")
                webbrowser.open("https://www.w3schools.com/")

            elif 'code with harry' in query:
                speak("Okay. here is code with harry youtube channel is opening. Please wait for a momment")
                print("Opening...")
                ...
                speak("Okay. here is techno gamerz youtube channel is opening. Please wait for a momment")
                print("Opening...")
                ...
                speak("Okay. here is beast boy shub youtube channel is opening. Please wait for a momment")
                print("Opening...")
                webbrowser.open("https://www.youtube.com/channel/UCI86prlqXhbkREDMTaORvLQ")

            elif 'technology gyan' in query:
                speak("Okay. technology gyan youtube channel is opening. Please wait for a momment")
                print("Opening...")
                webbrowser.open("https://www.youtube.com/channel/UC1tVU8H153ZFO9eRsxdJlhA")        

            elif 'make joke horror' in query:
                speak("Okay. make joke horror youtube channel is opening. Please wait for a momment")
                print("Opening...")
                ...
                speak("Playing sound")
                playsound('G:\\Python Projects\\Gravia\\sound effects\\sound of lion.wav')
            ...
            elif "which day it is" in query or "What day is today" in query or 'day' in query:
                ...
                playsound.playsound("G:\\Python Projects\\Gravia\\sound effects\\grandpa.wav")
                ...
                playsound.playsound("G:\\Python Projects\\Gravia\\sound effects\\grandma.wav")
                ...
                playsound.playsound(r"G:\Programming\Python Projects\Gravia\sound effects\mixkit-light-applause-with-laughter-audience-512.wav")
            ...
            # most asked question from google Assistant
                ...
                graviaPath = r"G:\Programming\Python Projects\Gravia\Gravia 1.1.py"
